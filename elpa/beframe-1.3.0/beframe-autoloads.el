...
(autoload 'beframe-assume-buffers-matching-regexp "beframe" "\
...
(fn REGEXP &optional MATCH-MODE-NAMES)" t)
(autoload 'beframe-unassume-buffers-matching-regexp "beframe" "\
...
(autoload 'beframe-kill-buffers-matching-regexp "beframe" "\
...
(fn REGEXP &optional MATCH-MODE-NAMES)" t)
 (autoload 'beframe-prefix-map "beframe")
...
(autoload 'beframe-rename-current-frame "beframe" "\
Convenience wrapper of `beframe-rename-frame' to rename the current frame." t)
(function-put 'beframe-rename-current-frame 'interactive-only 't)
(register-definition-prefixes "beframe" '("beframe-"))


;;; Generated autoloads from beframe-transient.el

 (autoload 'beframe-transient-assume "beframe-transient")
 (autoload 'beframe-transient-unassume "beframe-transient")
 (autoload 'beframe-transient "beframe-transient")

;;; End of scraped data
