...
;;
;; Package-Version: 20240615.517
;; Package-Revision: cd8ac4aee9ff
...
(defun tao-apply-custom-theme (theme-name)
  (custom-theme-set-faces
   ...
   `(mode-line                                        ((,class (:foreground ,color-12 :background ,color-1 :box nil :height ,(tao-theme-height 1.0)))))
   ...
   ;; diff-hl
   `(diff-hl-insert                                   ((,class (:background ,color-13)) (t (:background ,color-8))))
   `(diff-hl-change                                   ((t (:background ,color-13))))
   `(diff-hl-delete                                   ((,class (:background ,color-10)) (t (:background ,color-8))))
   `(diff-hl-dired-insert                             ((,class (:background ,color-13)) (t (:background ,color-8))))
   `(diff-hl-dired-change                             ((t (:background ,color-13))))
   `(diff-hl-dired-delete                             ((,class (:background ,color-10)) (t (:background ,color-8))))
   ;; dired
   ...
   ;; flymake
   ;; `(flymake-errline                                   ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-10) :inherit unspecified)) (t (:foreground ,color-7  :underline t))))
   ;; `(flymake-warnline                                 ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-9) :inherit unspecified)) (t (:foreground ,color-9  :underline t))))
   ...
   ;; `(flymake-errline                                  ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-10) :inherit unspecified :foreground unspecified :background unspecified)) (t (:foreground ,color-9 :weight bold))))
   ;; `(flymake-warnline                                 ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-11) :inherit unspecified :foreground unspecified :background unspecified)) (t (:foreground ,color-11 :weight bold))))
   ;; `(flymake-infoline                                 ((((supports :underline (:style wave))) (:underline (:style wave :color ,color-9) :inherit unspecified :foreground unspecified :background unspecified)) (t (:foreground ,color-8 :weight bold))))
   ;; flyspell
   ...
   `(helm-ff-file-extension                           ((t (:foreground ,color-14 :background ,color-4 :weight normal))))
   ...
   ;; linum-mode
   `(linum                                            ((t (:foreground ,color-7 :background ,color-4))))
   ;; macrostep
   ...
   ;; mic-paren
   `(paren-face-match                                 ((t (:foreground ,color-14 :weight bold))))
   `(paren-face-mismatch                              ((t (:foreground ,color-1 :underline t :background ,color-6 ))))
   ...
   ;; outline
   `(outline-1                                        ((t ( :height ,(tao-theme-height 1.3) :italic nil :inherit variable-pitch :variable-pitch t))))
   `(outline-2                                        ((t ( :height ,(tao-theme-height 1.2) :italic nil :inherit variable-pitch :variable-pitch t :underline nil))))
   `(outline-3                                        ((t ( :height ,(tao-theme-height 1.1) :italic nil :inherit variable-pitch :variable-pitch t))))
   `(outline-4                                        ((t ( :height ,(tao-theme-height 1.1) :italic nil :inherit variable-pitch :variable-pitch t :underline nil))))
   `(outline-5                                        ((t ( :height ,(tao-theme-height 1.1) :italic nil :inherit variable-pitch))))
