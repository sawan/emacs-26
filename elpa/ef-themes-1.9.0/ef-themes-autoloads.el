...
(put 'ef-eagle 'theme-properties (list :background-mode 'light :kind 'color-scheme :family 'ef))
...
(put 'ef-melissa-dark 'theme-properties (list :background-mode 'dark :kind 'color-scheme :family 'ef))
...
(put 'ef-owl 'theme-properties (list :background-mode 'dark :kind 'color-scheme :family 'ef))
...
(put 'ef-rosa 'theme-properties (list :background-mode 'dark :kind 'color-scheme :family 'ef))
